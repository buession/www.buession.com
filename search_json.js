      ...
      "children": [
        {
          ...
          "content": "快速入门TIP\n\n官方指南假设您已了解\"JAVA\"方面的相关知识。\n\nBuession Framework 是基于 springfrawork、jsckson、jedis、apache httpcomponents、okhttp3 等等众多的优秀的三方工具的标准化的、统一的类库的二次封装。同时，提供了众多常用的类库、方法、注解。Buession Framework 还在引用三方类库时，确保了版本的一致性，避免在不用三方类库引用的同一个三方类库版本不一致的情况。您可以根据本文档中的示例，快速熟悉 Buession Framework 的使用方法。"
        },
        {
          "title": "下一步可做什么？",
      ...
      "children": [
        {
          ...
          "content": "Buession Framework 框架是什么？Buession Framework 框架不是重复造车轮，它不是其它框架的替代品。它是基于作者在日常工作中遇到的常见需求或通用需求二次封装；它是作者其它同类开源框架的一种兼容性的上层封装，简化框架切换带来的成本。常用功能的封装文档完善中... ...其它同类开源框架的上层封装文档完善中... ..."
        }
      ]
    },
    {
      ...
      "children": [
        {
          ...
          "content": "APIBuession Framework API 包含以下目录：\n\n模块\n使用帮助\n手册\n\n\n\n\nbuession-aop\n使用帮助\nAPI 手册\n\n\nbuession-beans\n使用帮助\nAPI 手册\n\n\nbuession-core\n使用帮助\nAPI 手册\n\n\nbuession-cron\n使用帮助\nAPI 手册\n\n\nbuession-dao\n使用帮助\nAPI 手册\n\n\nbuession-geoip\n使用帮助\nAPI 手册\n\n\nbuession-httpclient\n使用帮助\nAPI 手册\n\n\nbuession-io\n使用帮助\nAPI 手册\n\n\nbuession-jdbc\n使用帮助\nAPI 手册\n\n\nbuession-json\n使用帮助\nAPI 手册\n\n\nbuession-lang\n使用帮助\nAPI 手册\n\n\nbuession-net\n使用帮助\nAPI 手册\n\n\nbuession-redis\n使用帮助\nAPI 手册\n\n\nbuession-session\n使用帮助\nAPI 手册\n\n\nbuession-thesaurus\n使用帮助\nAPI 手册\n\n\nbuession-velocity\n使用帮助\nAPI 手册\n\n\nbuession-web\n使用帮助\nAPI 手册\n\n\n"
        }
      ]
    },
    {
